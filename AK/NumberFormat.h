...
String human_readable_quantity(u64 quantity, HumanReadableBasedOn based_on = HumanReadableBasedOn::Base2, std::string_view unit = "B"sv, UseThousandsSeparator use_thousands_separator = UseThousandsSeparator::No);
